...
function StepArrowsComponent(props) {
    ...
    return (
        <Row>
            <img id='stepArrowLeft' src={imgSource} className={'img180'} onClick={handleClick(false)}/>
            <text>
                Step: {props.stepNumber}
            </text>
            <img id='stepArrowRight' src={imgSource} className={'img0'} onClick={handleClick(true)}/>
        </Row>
